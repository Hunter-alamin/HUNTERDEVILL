...
\033[1;95m☞ Facebook    : https://m.facebook.com/alaminkhan.60
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update Haunter Tool')
...
def mb():
	...
	if bm =='':
	    ...
	    time.sleep(2)
	    os.system('cd $HOME/HaunterBoy && python2 Haunter.py')
	elif bm =='3':
	    os.system('xdg-open https://chat.whatsapp.com/FmuKakzK8op6gpf9Xqr')
	    menu()
	elif bm =='4':
